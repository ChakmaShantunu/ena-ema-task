...
export default function Hero() {
    return (
        <div>
            ...
            <div className="max-w-xl md:max-w-4xl lg:max-w-6xl mx-auto">
                <h1 className="text-white mt-6 mb-4 text-4xl md:text-4xl lg:text-7xl text-center manrope font-bold">Strategic Landing Pages That Convert From Just <span className="text-secondary">$200</span></h1>
                <p className="text-center text-[#f5f5f5] w-11/12 md:max-w-6/12 lg:max-w-7/12 mx-auto">Stop wasting traffic on generic pages. We deliver premium, conversion-focused landing pages designed, developed, and launched in just 5 days.</p>
            </div>
